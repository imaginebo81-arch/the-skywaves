...
export default function BoutiqueCourses() {
  ...
  return (
    <section className="w-full max-w-[1400px] mx-auto px-4 md:px-12 pb-16">
      ...
      {course && (
        <div className={`bento-card overflow-hidden flex flex-col md:flex-row border border-gray-200 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 rounded-2xl group w-full min-h-[300px] ${courseGradients[5]}`}>
