    ...
    <div className="w-full bg-white shadow-lg overflow-hidden text-left rounded-2xl border border-gray-100 print:shadow-none print:rounded-none print:border-gray-200">
      ...
      <div className="bg-[#151b23] text-white px-10 py-6 flex items-center justify-between">
        ...
        <div className="text-right">
          <p className="text-gray-300 text-sm uppercase tracking-widest font-semibold">Statement of Marks</p>
        </div>
      </div>
        ...
        <div className="md:w-[70%] px-8 py-8 flex flex-col gap-5">
          ...
          {marks.length > 0 ? (
            <>
              ...
              {/* Result row — percentage only, no grade letter, no pass mark */}
              ...
              {summary.hasPendingMarks && (
                <p className="text-amber-600 text-xs bg-amber-50 border border-amber-200 rounded-lg px-4 py-2.5">
                  Some subject marks are pending — final result will update once all marks are entered.
                </p>
              )}
            </>
          ) : (
            <div className="flex-1 flex items-center justify-center py-12">
              <div className="text-center">
                ...
                <p className="text-gray-600 font-semibold text-base">Marks Not Yet Entered</p>
                <p className="text-gray-400 text-sm mt-1.5">Result will be available once marks are updated by the institute.</p>
              </div>
            </div>
          )}
        </div>
