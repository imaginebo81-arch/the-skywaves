...
export default function FashionPage() {
  ...
  // Filter courses for Fashion and Boutique categories
  const fashionCourses = marketingCourses.filter(
    (c) => c.category === "Fashion" || c.category === "Boutique"
  );
